...
<html>
	...
	<body>
                ...
                <table>
                    <tr>
                        <td style="padding-left:50px; padding-bottom:40px"> <br> <br>
                            <font size="4px">
                                <a href="read_admins.php" class="btn btn-primary" > BACK </a>
                            </font>
                        </td>
		...
		<div class="card card-sm">
			<h2 align="center" class="card-header"> EDIT ADMIN </h2>
			<form method="POST" action="update_admins.php?id=<?php echo $id; ?>" class="card-body">
				...
				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
					...
					<input type="email" class="form-control" name="email" value="<?php echo $row['email']; ?>" aria-describedby="inputGroup-sizing-sm">
				</div>
				
				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
					<span class="input-group-text" id="inputGroup-sizing-sm">password</span>
					<input type="password" class="form-control" name="password" value="<?php echo $row['password']; ?>" aria-describedby="inputGroup-sizing-sm">
				</div>
