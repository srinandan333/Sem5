<?php
	include('conn.php');
	$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from `appointment` where appointment_id='$id'");
...
<html>
	...
	<body>
                ...
                <table>
                    <tr>
                        <td style="padding-left:50px; padding-bottom:40px"> <br> <br>
                            <font size="4px">
                                <a href="read_appointments.php" class="btn btn-primary" > BACK </a>
                            </font>
                        </td>
		...
		<div class="card card-sm">
			<h2 align="center" class="card-header"> EDIT APPOINTMENT </h2>
			<form method="POST" action="update_appointments.php?id=<?php echo $id; ?>" class="card-body">
				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
					...
					<input type="number" class="form-control" name="appointment_id" value="<?php echo $row['appointment_id']; ?>" aria-describedby="inputGroup-sizing-sm">
				</div>
				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
				...
				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
					...
					<input type="date" class="form-control" name="date" value="<?php echo $row['date']; ?>" aria-describedby="inputGroup-sizing-sm">
				</div>
				
				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
					<span class="input-group-text" id="inputGroup-sizing-sm">time</span>
					<input type="time" class="form-control" name="time" value="<?php echo $row['time']; ?>" aria-describedby="inputGroup-sizing-sm">
				</div>

				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
					<span class="input-group-text" id="inputGroup-sizing-sm">symptoms</span>
					<input type="text" class="form-control" name="symptoms" value="<?php echo $row['symptoms']; ?>" aria-describedby="inputGroup-sizing-sm">
				</div>

				<div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
					<span class="input-group-text" id="inputGroup-sizing-sm">cost</span>
					<input type="number" class="form-control" name="cost" value="<?php echo $row['cost']; ?>" aria-describedby="inputGroup-sizing-sm">
				</div>
