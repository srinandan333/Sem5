...
<html>
    ...
    <body>
        ...
        <div class="card card-sm">
            <h2 align="center" class="card-header"> PATIENT TABLE </h2>
            <form method="POST" action="create_patients.php" class="card-body">
                ...
                <div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
                    ...
                    <input type="text" class="form-control" name="gender" aria-describedby="inputGroup-sizing-sm">
                </div>
                
                <div class="input-group input-group-sm mb-3" style="padding-left:250px; padding-right:250px">
                    <span class="input-group-text" id="inputGroup-sizing-sm">dob</span>
                    <input type="date" class="form-control" name="dob" aria-describedby="inputGroup-sizing-sm">
                </div>
                    ...
                    <?php
                        ...
                        while($row=mysqli_fetch_array($query))
                        {
                            ...
                            <tr>
                                ...
                                <td><a href="edit_patients.php?id=<?php echo $row['patient_id']; ?>" class="btn btn-warning btn-sm">Edit</a></td>
                                <td><a href="delete_patients.php?id=<?php echo $row['patient_id']; ?>" class="btn btn-danger btn-sm">Delete</a></td>
                            </tr>
                            <?php
                        }
                    ?>
